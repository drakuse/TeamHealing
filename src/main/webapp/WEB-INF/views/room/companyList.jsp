							...
							<div class="big-cta">
								<div class="cta-text">
									...
									<c:choose>
										...
										<c:when test="${co.COMPANY_APPROVE==0 }">
											<h3>
												<span>승인여부 : </span> <span>대기</span>
											</h3>
										</c:when>
										<c:when test="${co.COMPANY_APPROVE==1 }">
											<h3>
												<span>승인여부 : </span> <span>승인</span>
											</h3>
											<h3>
												<a href="roomList?COMPANY_NUM=${co.COMPANY_NUM}"
													class="btn btn-success btn-rounded"><i
													class="fa fa-home"></i>&nbsp;방목록</a>
											</h3>
										</c:when>
