...
<head>
<meta charset="UTF-8">
<title>memberModefyCheckForm.jsp 파일입니다.</title>
...
<body>
	...
	<!-- end header -->
	<form action="memberModifyCheck" name="memberModifyCheckForm"
		id="memberModifyCheckForm" method="post">
		<div class="login">
			<input type="text" placeholder="Username" name="MEMBER_ID"
				id="MEMBER_ID" value="${MEMBER_ID }" readonly="readonly"> <input
				type="password" placeholder="password" name="MEMBER_PASS"
				id="MEMBER_PASS"><input type="button" onclick="submit()"
				value="확인"><input type="button" onclick="cancel()"
				value="취소">
		</div>
