...
public class ProductVO {
	...
	public String toString() {
		return "ProductVO [PRODUCT_NAME=" + PRODUCT_NAME + ", PRODUCT_NUM=" + PRODUCT_NUM + ", PRODUCT_PRICE="
				+ PRODUCT_PRICE + ", PRODUCT_AMOUNT=" + PRODUCT_AMOUNT + ", PRODUCT_IMAGE_NAME=" + PRODUCT_IMAGE_NAME
				+ ", PRODUCT_IMAGE=" + PRODUCT_IMAGE + ", PRODUCT_INFO=" + PRODUCT_INFO + ", PRODUCT_CATEGORY="
				+ PRODUCT_CATEGORY + "]";
	}
